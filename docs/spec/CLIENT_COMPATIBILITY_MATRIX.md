...
| Built-in quests/missions/content systems | Out of scope unless source-proven | No dedicated C++ core runtime found | Absence is faithful behavior; do not implement built-ins without C++ source or byte-capture proof |
