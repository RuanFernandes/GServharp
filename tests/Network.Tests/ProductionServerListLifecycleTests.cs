...
public sealed class ProductionServerListLifecycleTests
{
    [Fact]
    public void ConnectServerSuccessUsesConfirmedRegistrationPacketOrderAndCodecSwitch()
    {
        ...
        var lifecycle = new ProductionServerListLifecycle(socket);

        var result = lifecycle.ConnectServer(new ProductionServerListConnectOptions(
    ...
    private static ProductionServerListConnectOptions DefaultOptions() =>
        new(
            ListIp: "list.example.test",
            ListPort: "14900",
            Name: "Classic",
    ...
    private sealed class RecordingServerListSocket : IProductionServerListSocket
    {
